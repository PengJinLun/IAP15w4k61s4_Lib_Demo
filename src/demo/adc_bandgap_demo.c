...
//	u8	k;
	...
	while (1)
	{
		for(i=0; i<3; i++)
		{
			...
			j=(float)j*5*100/1024;       //5/1024 5v电压份1024份 值为每一份的值 ad为采集的份数  与其相乘为采集的电压值 *100小数点后两位 
